Module Module1
    ...
    Sub Main()
        ...
        Dim TimeConfig As ControlI2C.VII_TIME_CONFIG
        TimeConfig.tSU_STA = 5
        TimeConfig.tHD_STA = 4
        TimeConfig.tLOW = 5
        TimeConfig.tHIGH = 5
        TimeConfig.tSU_DAT = 1
        TimeConfig.tSU_STO = 4
        TimeConfig.tBuf = 5
        ret = ControlI2C.VII_TimeConfig(ControlI2C.VII_USBI2C, 0, 0, TimeConfig)
